const moneyPrinterSignal = (needsTicksLow, needsTicksHigh, needsPercentage, needsMaxPercentage, priceData) => {
    let lastPrice = 0;
...
console.log(moneyPrinterSignal(5, 2, 0.1, 0.2, mockPriceData));

module.exports = moneyPrinterSignal